...
public class Konut {
    ...
    public Konut(int id, int ilanId, String odaSayisi, int binaYasi, int binaKat, int binaKacinciKat) {
        this.id= id;
        this.ilanId = ilanId;
    ...
    public Konut(int id, int ilanId, String odaSayisi, int binaYasi, int binaKat, int binaKacinciKat, ArrayList<String> resimPath, int iilanId, String ilanBaslik, int ilanFiyat, String kategoriAd, String islemAd, int userId, String ilanAdres, String ilanAciklama) {
        this.id = id;
        this.ilanId = ilanId;
        this.odaSayisi = odaSayisi;
        this.binaYasi = binaYasi;
